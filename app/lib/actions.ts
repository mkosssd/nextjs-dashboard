...
const AddCustomer = addCustomerFormSchema.omit({})
export async function addCustomers(prevState: CustomerState, formData: FormData) {
	...
	let { name, email, image_url } = validatedFields.data;
    if(!image_url){
        image_url = '/customers/noProfile.jpg'
    }
	// Insert data into the database
	try {
		await sql`
		INSERT INTO customers (name, image_url, email)
		VALUES (${name}, ${image_url}, ${email})
		`;
	} catch (error) {
